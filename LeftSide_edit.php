...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Update Left Side News</title>
...
<body style="background-color: rgba(226, 223, 223, 0.842);">
  ...
  <div class="admin-content" style="background-color: rgba(226, 223, 223, 0.842);">
    ...
    <div class="card shadow mb-4">
          ...
          if(isset($_POST['edit_dataLeftSide_btn']))
          {
              $id=$_POST['edit_id'];
            ...
            <form action="UpdateValid.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Title</label>
                    <input type="text" name="Edit_TitleLeft" value="<?php echo $row['title'] ?>" class="form-control">
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Author</label>
                    <input type="text" name="Edit_AuthorLeft" value="<?php echo $row['author'] ?>" class="form-control">
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Date</label>
                    <input type="date" name="Edit_DateLeft" value="<?php echo $row['date'] ?>"class="form-control">
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Description</label><br>
                    <textarea name="Edit_Left_des" style="width:100%;" rows="3"><?php echo $row['description']?></textarea>
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                <label>Upload Image</label>
                  <input type="file" id="Left_image" name="Left_image" value="<?php echo $row['image'] ?>" class="form-control">
                </div>
                <div class="caasda" style="display:flex; margin:2% " >
                    <a href="LeftSideAdmin.php" class="btn btn-danger" style="height:40px; margin-right:.5%;" >Cancel </a>
                    <button type="submit" class="btn btn-primary" name="LeftSide_updatebtn"> Update </button>
                </div>
            </form>
