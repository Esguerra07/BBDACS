...
<body style="background-color: rgba(226, 223, 223, 0.842);">
  ...
  <div class="admin-content" style="background-color: rgba(226, 223, 223, 0.842);">
    ...
    <div class="card shadow mb-4">
          ...
          {
              $id=$_POST['edit_id'];
              $query = "SELECT * FROM hotline WHERE id='$id' ";
            ...
            <form action="UpdateValid.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>News</label>
                    <input type="text" name="Edit_News" value="<?php echo $row['title'] ?>" class="form-control" placeholder="Enter Title">
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                <label>Upload Image</label>
                  <input type="file" id="Hotline_image" name="Hotline_image" value="<?php echo $row['image'] ?>" class="form-control">
                </div>
                <div class="caasda" style="display:flex; margin:2% " >
                    <a href="HotlineAdmin.php" class="btn btn-danger" style="height:40px; margin-right:.5%;" >Cancel </a>
                    <button type="submit" class="btn btn-primary" name="hotline_updatebtn"> Update </button>
                </div>
            </form>
