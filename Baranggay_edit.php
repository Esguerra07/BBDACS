...
<body style="background-color: rgba(226, 223, 223, 0.842);">
  ...
  <div class="admin-content" style="background-color: rgba(226, 223, 223, 0.842);">
    ...
    <div class="card shadow mb-4">
          ...
          if(isset($_POST['edit_baranggay_btn']))
          {
              $id=$_POST['edit_id'];
              $query = "SELECT * FROM baranggay WHERE id='$id' ";
            ...
            <form action="UpdateValid.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Title</label>
                    <input type="text" name="Edit_TitleBaranggay" value="<?php echo $row['baranggay'] ?>" class="form-control">
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Upload Image</label>
                    <input type="file" id="Baranggay_image" name="Baranggay_image" value="<?php echo $row['image'] ?>" class="form-control">
                </div>
                <div class="caasda" style="display:flex; margin:2% " >
                    <a href="BaranggayAdmin.php" class="btn btn-danger" style="height:40px; margin-right:.5%;" >Cancel </a>
                    <button type="submit" class="btn btn-primary" name="Baranggay_updatebtn"> Update </button>
                </div>
            </form>
