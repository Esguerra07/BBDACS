    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="GuidesAdmin.php">Guides</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
          ...
          if(isset($_POST['edit_about_btn']))
          {
            ...
            <form action="UpdateValid.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Title</label>
                    <input type="text" name="Edit_TitleAbout" value="<?php echo $row['title'] ?>" class="form-control">
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Description</label><br>
                    <textarea name="Edit_About_des" style="width:100%;" rows="3"><?php echo $row['description']?></textarea>
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                <label>Upload Image</label>
                  <input type="file" id="About_image" name="About_image" value="<?php echo $row['image'] ?>" class="form-control">
                </div>
                <div class="caasda" style="display:flex; margin:2% " >
                    <a href="AboutAdmin.php" class="btn btn-danger" style="height:40px; margin-right:.5%;" >Cancel </a>
                    <button type="submit" class="btn btn-primary" name="About_updatebtn"> Update </button>
                </div>
            </form>
