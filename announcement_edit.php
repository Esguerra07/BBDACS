          ...
          if(isset($_POST['edit_data_btn']))
          {
            ...
            <form action="UpdateValid.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="width:96%; margin-left:2%">
                    <label>Title</label>
                    <input type="text" name="Edit_Announcement" value="<?php echo $row['title'] ?>" class="form-control" placeholder="Enter Title">
                </div>
                <div class="form-group" style="width:96%; margin-left:2%">
                <label>Upload Image</label>
                  <input type="file" id="Announcement_imageHotline_image" name="Announcement_image" value="<?php echo $row['images'] ?>" class="form-control">
                </div>
                <div class="caasda" style="display:flex; margin:2% " >
                    <a href="AnnouncementAdmin.php" class="btn btn-danger" style="height:40px; margin-right:.5%;" >Cancel </a>
                    <button type="submit" class="btn btn-primary" name="announcement_updatebtn"> Update </button>
                </div>
            </form>
